...
const WPD_DATA = {
  ...
  districts: {
    1: {
      ...
      color: "#2563EB",
      coverage: "Historic Downtown Square, Devonshire Estates, WCHS Campus & East Sector",
      acres: "433.6 Acres",
      boundaries: "Territory east of North Wilmor Road to eastern municipal limits, bounded by Devonshire Road corridor to the north, encompassing Historic Downtown Square, WPD Police Headquarters, City Hall, Lincoln Grade School, and Washington Community High School.",
      landmarks: [
    ...
    2: {
      ...
      color: "#059669",
      coverage: "West Washington, Freedom Parkway Hub, Middle School & Western Subdivisions",
      acres: "1,681.4 Acres",
      boundaries: "Territory south of Washington Road (Business 24) from Wilmor Road west to Cummings Lane, and extending across the entire western municipal boundaries west of Cummings Lane, including Freedom Parkway retail corridor, Centennial Drive, Washington Middle School, and Meadow Valley Park.",
      landmarks: [
        "Freedom Parkway Retail Center & Walmart Supercenter",
        "Washington Middle School (District 52 Campus / 1100 Centennial Dr)",
      ...
      priority: "Retail loss deterrence, school transit safety, commercial corridor speed enforcement, western residential neighborhood patrols"
    },
    3: {
      id: 3,
  ...
  streets: [
    ...
    { name: "North Main St", district: 1, area: "North Main Core Corridor" },
    ...
    { name: "Centennial Dr", district: 2, area: "Washington Middle School Artery" },
    ...
    { name: "Peoria St", district: 2, area: "West Commercial Corridor (Bus 24)" },
